...
// Accessor Methods
     ...
     */
    boolean insert(Edge edge);
    /** Determine whether an edge exists.
     @param source The source vertex
     @param dest The destination vertex
     @return true if there is an edge from source to dest
     */
    boolean isEdge(NonConflictingSchedules.OfferedClass source, NonConflictingSchedules.OfferedClass dest);
     ...
     */
    Edge getEdge(NonConflictingSchedules.OfferedClass source, NonConflictingSchedules.OfferedClass dest);
    /** Return an iterator to the edges connected to a given vertex.
     @param source The source vertex
     @return An Iterator<Edge> to the vertices connected to source
     */
    Iterator<Edge> edgeIterator(NonConflictingSchedules.OfferedClass source);
}
