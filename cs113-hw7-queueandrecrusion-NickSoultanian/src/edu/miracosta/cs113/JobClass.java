...
public class JobClass implements Comparable<JobClass> {
     ...
     *            The number of pages
     */
    public JobClass(int jobNum, int pages) {
        this.jobNum = jobNum;
        this.pages = pages;
        setPriority(pages);
    }
    ...
    public boolean equals(Object other) {
        if (other != null && other instanceof JobClass) {
            return ((JobClass) other).getPriority() == getPriority();
        }
        return false;
    }
     ...
     */
    @Override
    public int compareTo(JobClass other) {
        if (other != null) {
            return getPriority() - ((JobClass) other).getPriority();
        }
        return 0;
    }
